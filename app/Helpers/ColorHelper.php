...
class ColorHelper
{
    protected static $tailwindColors = [
        'bg-red-50' => '#fef2f2',
        'bg-red-100' => '#fee2e2',
        'bg-red-200' => '#fecaca',
        'bg-red-300' => '#fca5a5',
        ...
        'bg-fuchsia-600' => '#a21caf',
        'bg-fuchsia-700' => '#86198f',
        'bg-fuchsia-800' => '#701a75',
        'bg-fuchsia-900' => '#4a044e',
    ...
    public static function getClosestTailwindClass($hex)
    {
        $inputRgb = self::hexToRgb($hex);
        $closest = null;
        $minDistance = PHP_INT_MAX;

        foreach (self::$tailwindColors as $class => $tailwindHex) {
            $rgb = self::hexToRgb($tailwindHex);
            $distance = self::rgbDistance($inputRgb, $rgb);
    ...
    private static function rgbDistance($rgb1, $rgb2)
    {
        return sqrt(
            pow($rgb1['r'] - $rgb2['r'], 2) +
                pow($rgb1['g'] - $rgb2['g'], 2) +
