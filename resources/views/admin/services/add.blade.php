                    ...
                    <div class="card-body service-form admin-form">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" required placeholder="Brief description for service cards"></textarea>
                            </div>

                            <div class="form-group mb-3">
                                <label for="long_description" class="form-label">Long Description</label>
                                <textarea class="form-control" id="long_description" name="long_description" rows="5" placeholder="Detailed description for service pages"></textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <button type="button" id="add-point" class="btn btn-outline-primary btn-sm add-field-btn">Add Point</button>
                            </div>
