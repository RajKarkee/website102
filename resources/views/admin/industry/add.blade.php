            ...
            <form id="industryForm" method="POST" action="{{ route('admin.industry.add') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="icon" name="icon" class="dropify"
                        data-allowed-file-extensions="png jpg jpeg svg" data-max-file-size="2M" data-height="200"
                        data-show-remove="true" data-show-loader="true" data-show-errors="true"
                        data-errors-position="outside" data-allowed-formats="landscape" data-default-file="" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div id="points-wrapper">
                        <div class="point-input">
                            ...
                            <input type="text" name="points[]" class="form-control d-inline-block w-75" maxlength="255"
                                required placeholder="Point">
