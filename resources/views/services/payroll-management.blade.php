...
@section('meta_description', 'Professional payroll management services including payslip preparation, leave management,
    and KiwiSaver compliance for New Zealand businesses.')
...
@section('content')
    <div class="min-h-screen bg-background text-foreground">
        ...
        @include('components.jumbotron', [
            ...
            'description' =>
                'Comprehensive payroll services ensuring your employees are paid correctly and on time, with full compliance to New Zealand employment laws.',
            'backgroundImage' =>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted-foreground">Annual leave, sick leave, and statutory holiday
                                    calculations</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                        alt="Payroll management services" class="rounded-2xl shadow-xl">
                </div>
            </div>
            ...
            @include('components.cta', [
                'icon' => 'dollar-sign',
                'title' => 'Affordable Payroll Solutions',
                'description' =>
                    'Our payroll management services start from just $50 per month for small businesses. Contact us for a customized quote based on your specific needs.',
